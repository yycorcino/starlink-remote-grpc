...
import (
	status "github.com/Eitol/starlink-client/libs/golang/client/gen/spacex/api/common/status"
...
func (x *Request) GetStartDishSelfTest() *StartDishSelfTestRequest {
	if x, ok := x.GetRequest().(*Request_StartDishSelfTest); ok {
...
func (x *Response) GetStartDishSelfTest() *StartDishSelfTestResponse {
	if x, ok := x.GetResponse().(*Response_StartDishSelfTest); ok {
		return x.StartDishSelfTest
	}
	return nil
}
